...
const DownloadScheduleButton: React.FC<DownloadScheduleButtonProps> = ({ schedule }) => {
  ...
  return (
    <PDFDownloadLink
      ...
      className="text-md text-white bg-green-600 hover:bg-green-700 border-0 rounded-md hover:scale-105 font-semibold duration-75 p-1 shadow-sky-800 shadow-md flex items-center" title="Baixar Escala"
    >
